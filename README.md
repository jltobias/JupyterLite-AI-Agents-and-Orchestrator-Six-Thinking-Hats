...
- **Notebook 1 — Six Hat Agents:** https://jltobias.github.io/JupyterLite-AI-Agents-and-Orchestrator-Six-Thinking-Hats/lite/lab/index.html?path=01_six_hats_agents.ipynb
- **Notebook 2 — Orchestrator Lab:** https://jltobias.github.io/JupyterLite-AI-Agents-and-Orchestrator-Six-Thinking-Hats/lite/lab/index.html?path=02_orchestrator_lab.ipynb
- **Notebook 3 — Build Your Own Backend:** https://jltobias.github.io/JupyterLite-AI-Agents-and-Orchestrator-Six-Thinking-Hats/lite/lab/index.html?path=03_backend_adapter.ipynb

## What you will learn

1. What makes an AI agent different from a single prompt.
2. How to represent the six hats as role-specialized agents.
3. Why the **Blue Hat agent** and the **Orchestrator** are related but distinct:
...
4. How the story of the **blind men and the elephant** illustrates partial truth, perspective blindness, and the need for synthesis.
5. How to run the learning environment entirely in a browser with JupyterLite.
6. How to replace the included browser-safe teaching backend with a real LLM through a secure backend/proxy.
...
- de Bono, Edward. *Six Thinking Hats*. First published in 1985; current Penguin editions are available. Official overview: https://www.debono.com/Books/six-thinking-hats and Penguin edition details: https://www.penguin.co.uk/books/486667/six-thinking-hats-by-bono-edward-de/9780241257531
